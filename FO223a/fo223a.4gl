      ...
      ON KEY(F5, CONTROL-W)
         ...
         THEN
            ...
            THEN
               ...
               DISPLAY P1[aln].machcode TO SR[aln].machcode
            ELSE
               IF frmtyp = '2' THEN
